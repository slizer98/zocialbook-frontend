...
<template>
  <header>
    <div class="border border-red-500 h-28 w-full relative">
      <figure
        class="h-16 w-16 border border-red-500 bg-black rounded-full absolute -bottom-8 left-2"
      >
        <img src="" alt="" />
      </figure>
    </div>
    <main class="font-sans w-full flex border border-red-500 flex-col space-y-4 px-5 pb-14">
      <section class="space-y-4 ">
        <div class="pl-14 pt-2">
          <h1 class="font-semibold text-gray-100">Erick Villafuerte</h1>
      ...
      <!-- Sobre mi -->
      <section>
        <h2 class="font-semibold text-gray-100">Sobre mi</h2>
