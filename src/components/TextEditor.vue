...
<template>
  <div>
    ...
    <div class="w-full relative">
      ...
      <div class="">
        <div v-if="showPopover" class="absolute w-[363px] h-[300px] overflow-y-scroll -top-60 right-0 bg-white border border-gray-300 p-2 rounded-sm">
          ...
          <ul class="mb-4">
            ...
            <li class="text-sm"><strike>&lt;strike&gt;</strike>: Para tachar el texto.</li>
